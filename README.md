...
$ cd <path-to-ot-samr21>/output/samr21/bin
...
OpenThread is released under the [BSD 3-Clause license](https://github.com/openthread/ot-samr21/blob/master/LICENSE). See the [`LICENSE`](https://github.com/openthread/ot-samr21/blob/master/LICENSE) file for more information.
